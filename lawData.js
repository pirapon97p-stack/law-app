const lawData = [
  ...
  },
  {
    ...
    elements: "1. กฎหมายใหม่เปลี่ยนสภาพจากโทษไปเป็นวิธีการเพื่อความปลอดภัย\n2. ให้ถือว่าโทษเดิมเปลี่ยนสภาพ และใชับังคับเงื่อนไขที่เป็นคุณตามกฎหมายใหม่"
  },
  {
    book: "ภาค 1 บทบัญญัติทั่วไป",
    title_group: "ลักษณะ 1 บทบัญญัติที่ใช้แก่ความผิดทั่วไป",
    chapter: "หมวด 2 การใช้กฎหมายอาญา",
    section: "16",
    title: "การเพิกถอนหรืองดการใช้วิธีการเพื่อความปลอดภัย",
    text: "เมื่อศาลได้พิพากษาให้ใช้บังคับวิธีการเพื่อความปลอดภัยแก่ผู้ใดแล้ว ถ้าภายหลังความปรากฏแก่ศาลตามคำเสนอของผู้นั้นเอง ผู้แทนโดยชอบธรรมของผู้นั้น ผู้อนุบาลของผู้นั้นหรือพนักงานอัยการว่า พฤติการณ์เกี่ยวกับการใช้บังคับนั้นได้เปลี่ยนแปลงไปจากเดิม ศาลจะสั่งเพิกถอนหรืองดการใช้บังคับวิธีการเพื่อความปลอดภัยแก่ผู้นั้นไว้ชั่วคราวตามที่เห็นสมควรก็ได้",
    elements: "1. พฤติการณ์ของผู้ถูกใช้บังคับเปลี่ยนแปลงไปจากเดิม\n2. ศาลมีอำนาจสั่งเพิกถอน หรือระงับ/งดการใช้บังคับไว้ชั่วคราวได้"
  },
  {
    book: "ภาค 1 บทบัญญัติทั่วไป",
    title_group: "ลักษณะ 1 บทบัญญัติที่ใช้แก่ความผิดทั่วไป",
    chapter: "หมวด 2 การใช้กฎหมายอาญา",
    section: "17",
    title: "การนำภาค 1 ไปใช้กับกฎหมายอื่น",
    text: "บทบัญญัติในภาค ๑ แห่งประมวลกฎหมายนี้ ให้ใช้ในกรณีแห่งความผิดตามกฎหมายอื่นด้วย เว้นแต่กฎหมายนั้น ๆ จะได้บัญญัติไว้เป็นอย่างอื่น",
    elements: "1. หลักทั่วไปในภาค 1 นำไปใช้กับกฎหมายอื่นได้ทั้งหมด\n2. เว้นแต่กฎหมายเฉพาะนั้นๆ จะได้บัญญัติไว้เป็นอย่างอื่น"
  }
];
